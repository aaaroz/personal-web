...
export const Sidebar = ({
  ...
  return (
    <aside
      ...
      className="group hidden sticky z-50 top-0 sm:flex flex-col min-w-60 space-y-5 py-10 justify-between min-h-screen max-h-screen data-[collapsed=true]:min-w-10  data-[collapsed=true]:max-w-12"
    >
