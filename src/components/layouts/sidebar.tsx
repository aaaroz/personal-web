...
export const Sidebar = ({
  ...
  return (
    <aside
      ...
      className="group hidden sticky top-0 sm:flex flex-col justify-between min-w-60 space-y-10 py-10 max-h-screen data-[collapsed=true]:min-w-10  data-[collapsed=true]:max-w-12"
    >
